# SIPRA-UNTAD (Sistem Pelaporan Infrastruktur Kampus)

Sistem Pelaporan Infrastruktur Kampus Universitas Tadulako (SIPRA-UNTAD) adalah platform berbasis web responsif yang dirancang untuk mengelola siklus pelaporan masalah dan penanganan kerusakan fasilitas fisik di lingkungan kampus (Bumi Tadulako Tondo, Palu). Sistem ini mengintegrasikan interaksi antara pelapor (sivitas akademika dan tamu), teknisi lapangan, administrator sarana-prasarana, serta pimpinan universitas secara transparan dan terstruktur.
...
```bash
git clone https://github.com/username/project-klh.git
cd project-klh
npm install
```
